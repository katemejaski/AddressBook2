...
public class AddressBook {
    ...
    public void addNewEntry(String FirstName, String LastName, String PhoneNuumber, String eMail)
    {
        ...
        {
            validEmail=false;
            System.out.println("You did not enter an email address");
        }
        ...
        {
            validEmail=false;
            System.out.println("Incorrect email format. Entry will not be added");
        }
        ...
        for ( index = 0; index < phonebook.size(); index++) {
            if (eMail.equalsIgnoreCase(phonebook.get(index).geteMail())) {
                System.out.println("This email already exists. No record will be added");
                doesExist = true;
                break;
